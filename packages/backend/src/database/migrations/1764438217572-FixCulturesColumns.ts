...
export class FixCulturesColumns1764438217572 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "cultures" RENAME COLUMN "planting_date" TO "plantingDate"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cultures" RENAME COLUMN "planting_area" TO "plantingArea"`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "cultures" RENAME COLUMN "plantingDate" TO "planting_date"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cultures" RENAME COLUMN "plantingArea" TO "planting_area"`,
    );
